...
void test_insert_people(Heap<Patient> *);
...
void test_insert_people(Heap<Patient> *mheap)
{
    Patient p1("A1", "A1");
    Patient p2("A2", "A2");
    Patient p3("A3", "A3");
    ...
    p1.calculate_priority(true, true, 100, 80, 14, true);
    p2.calculate_priority(false, false, 100, 80, 20, true);
    p3.calculate_priority(true, false, 100, 80, 13, true);
    p4.calculate_priority(false, false, 85.8, 100, 100, true);
    p5.calculate_priority(false, false, 100, 80, 4, true);
    p6.calculate_priority(false, true, 88, 50, 4, true);
    p7.calculate_priority(false, true, 88, 100, 1, true);
    p8.calculate_priority(false, true, 88, 100, 22, true);
    p9.calculate_priority(false, true, 300, 100, 13, true);
    p10.calculate_priority(true, true, 85.8, 100, 109, true);
    p11.calculate_priority(false, false, 85.8, 100, 90, true);
    p12.calculate_priority(true, true, 100, 80, 2, true);
    p13.calculate_priority(false, false, 100, 100, 12, true);
    p14.calculate_priority(true, true, 100, 80, 14, true);
