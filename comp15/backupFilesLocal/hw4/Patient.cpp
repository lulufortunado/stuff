...
// for testing purposes only - prints patient information with time_in
void Patient::print_with_time_in(ostream &out)
{
    out << fname << " " << lname << endl;
    out << ((head_wound) ? "Head wound\n" : "");
    out << ((chest_pain) ? "Chest pain\n" : "");
    out << "Pulse: " << pulse << endl;
    out << "Temp: " << temp << endl;
    out << "Time In: " << time_in << endl;
