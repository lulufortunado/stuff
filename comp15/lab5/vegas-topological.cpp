...
void print_adjacency(LinkedList<string> dependencies[]);
...
int main(int argc, char *argv[])
{
    ...
    print_adjacency(dependencies);
    cout <<" calling print_topo" << endl;
...
void print_adjacency(LinkedList<string> dependencies[])
{
     cout << endl << "***********************\n";
            ...
            for (int i = 0; i < dependencies[0].get_length(); i++)
            {
                cout <<  dependencies[0].get_value_at(i) << " ";
            }
            cout << endl;

            for (int i = 0; i < dependencies[1].get_length(); i++)
            {
                cout <<  dependencies[1].get_value_at(i) << " ";
            }
            cout << endl;

            for (int i = 0; i < dependencies[2].get_length(); i++)
            {
                cout <<  dependencies[2].get_value_at(i) << " ";
            }
            cout << endl;

            for (int i = 0; i < dependencies[3].get_length(); i++)
            {
                cout <<  dependencies[3].get_value_at(i) << " ";
            }
            cout << endl;

            for (int i = 0; i < dependencies[4].get_length(); i++)
            {
                cout <<  dependencies[4].get_value_at(i) << " ";
            }
            cout << endl;

            for (int i = 0; i < dependencies[5].get_length(); i++)
            {
                cout <<  dependencies[5].get_value_at(i) << " ";
            }
            cout << endl;

            for (int i = 0; i < dependencies[6].get_length(); i++)
            {
                cout <<  dependencies[6].get_value_at(i) << " ";
            }
            cout << endl;
